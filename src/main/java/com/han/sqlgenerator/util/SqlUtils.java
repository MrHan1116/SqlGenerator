package com.han.sqlgenerator.util;
...
public class SqlUtils {
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "D:/test/SqlGenerator/src/main/java/com/han/sqlgenerator/entity";
        //生成sql的文件夹
        String filePath = "D:/test/SqlGenerator/src/main/resources/sql/";
        //生成sql的命名
        String fileName = "" + ".sql";
        //项目中实体类的路径
        String prefix = "com.han.sqlgenerator.entity.";
        String className = "";
